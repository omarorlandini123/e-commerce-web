        ...
        <div class="row">
            ...
            <div class="col-8" >
                ...
                <div class="form-group">                                
                    <input type="number" onkeyup="calcular2({{$detalle->producto->producto_id}})" class="form-control producto" id_producto="{{$detalle->producto->producto_id}}" name="prod_{{$detalle->producto->producto_id}}" id="prod_{{$detalle->producto->producto_id}}" aria-describedby="cantidad" placeholder="¿Cuántos quieres?">
